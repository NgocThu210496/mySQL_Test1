...
INSERT INTO Catalog (CatalogID, ProductName, Description, StatusCatalog)
VALUES
...
VALUES
    ('U001', 'user1', 'password1', 'user1@gmail.com', '0123456789', 'Hà Nội', '1990-11-9'),
    ('U002', 'user2', 'password2', 'user2@gmail.com', '0944454321', 'Quảng Nam','2000-05-15'),
    ('U003', 'user3', 'password3', 'user3@gmail.com', '0369855555', 'Đà Nẵng', '1998-2-7'),
    ('U004', 'user4', 'password4', 'user4@gmail.com', '0321657861', 'Cần Thơ', '2001-06-22'),
    ('U005', 'user5', 'password5', 'user5@gmail.com', '0999779654', 'Hà Tĩnh', '1995-08-10');
SELECT *FROM User;
...
SELECT c.CatalogID, c.ProductName AS TenDanhMuc, COUNT(p.ProductId) AS SoLuongSanPham
	FROM Catalog c
	LEFT JOIN Product p ON c.CatalogID = p.CatalogID
	GROUP BY c.CatalogID, c.ProductName;
